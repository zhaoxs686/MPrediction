...
class BertModel(BertPreTrainedModel):
    ...
    Inputs:
        ...
        `output_all_encoded_layers`: boolean which controls the content of the `encoded_layers` output_model as described below. Default: `True`.
    ...
    Outputs: Tuple of (encoded_layers, pooled_output)
        ...
        `pooled_output`: a torch.FloatTensor of size [batch_size, hidden_size] which is the output_model of a
